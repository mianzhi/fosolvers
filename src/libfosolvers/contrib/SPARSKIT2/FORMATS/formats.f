...
c ia	= integer array of length max(nnz,n+1) containing the row 
c 	  positions of the corresponding elements in a.
...
c         if you want them sorted. Note also that ia has to have at
c         least n+1 locations 
c----------------------------------------------------------------------c
...
c a, ja, ia == matrix in CSR format  -- only ia is used.        
